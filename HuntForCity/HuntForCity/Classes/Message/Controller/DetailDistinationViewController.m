...
{
    if (indexPath.section ==0) {
        return CGSizeMake((AppWidth-4)/2, 120*(AppHeight/667.0));
    }else{
        return CGSizeMake(AppWidth-4, 100*(AppHeight/667.0));
    }
}
...
{
    if (section ==0) {
        return CGSizeMake(AppWidth, 250*(AppHeight/667.0));
    }else{
        return CGSizeMake(AppWidth, 25*(AppHeight/667.0));
    }
}
...
-(void)createAD
{
    ...
    adview.scrollView.contentSize = CGSizeMake(_adArray.count*AppWidth, 250);
    ...
    for (int i=0; i<_adArray.count; i++) {
        ...
        imageV.frame = CGRectMake(i*AppWidth, 0, AppWidth, 250);
        ...
        UILabel *cnameLabel = [self creatLabelWithText:cname andWithFrame:CGRectMake(20+i*AppWidth, 150, 100, 20) andWithFont:[UIFont systemFontOfSize:18] andColor:[UIColor whiteColor]];
        UILabel *enameLabel = [self creatLabelWithText:ename andWithFrame:CGRectMake(20+i*AppWidth, 170, 100, 20) andWithFont:[UIFont systemFontOfSize:16] andColor:[UIColor whiteColor]];
        UILabel *infoLabel = [self creatLabelWithText:info andWithFrame:CGRectMake(20+i*AppWidth, 200, AppWidth-50, 50) andWithFont:[UIFont systemFontOfSize:16] andColor:[UIColor whiteColor]];
